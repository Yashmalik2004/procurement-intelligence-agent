...
class SupplierScoreAcceptedResponse(BaseModel):
    """Returned immediately by POST /procurement/supplier/score."""
    status: str
    score_id: str           # unique job identifier — use to poll GET endpoint
    supplier_name: str
    category: str
...
class SupplierScoreResult(BaseModel):
    """Returned by GET /procurement/supplier/score/{score_id} once scoring is complete."""
    score_id: str
    supplier_name: str
